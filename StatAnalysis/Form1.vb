...
Public Class Form1
    ...
    Private Sub btnCalcRunCharts_Click(sender As Object, e As EventArgs) Handles btnCalcRunCharts.Click
        ...
        AR.SQL = "SELECT SerialNumber FROM TempPumpData WHERE ModelNumber = '" & SelectedModelNumber & "' AND ImpellerDia = " & CDbl(SelectedImpellerSize) & ";"
        ...
        ExcelRoutn.WriteDataToExcel(ExcelRoutn.MetricDataViewToArray(DV), "A4")
        ...
        ExcelRoutn.PlotCharts(DSSerialNumbers.Tables(0).Rows.Count, txtDesignHead.Text <> "", txtDesignFlow.Text, txtDesignHead.Text, SelectedModelNumber, SelectedImpellerSize)
    ...
    Private Sub lbSN_SelectedIndexChanged(sender As Object, e As EventArgs) ' Handles cmbSN.SelectedIndexChanged
        ...
        Dim ModelNo As String = lbSN.GetItemText(lbSN.SelectedItem)
