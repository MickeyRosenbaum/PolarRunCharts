...
Public Class ExcelRoutines
    ...
    Public Function MetricDataViewToArray(DV As DataView) As Array
        ...
        Return arr
    End Function
    Public Sub WriteDataToExcel(arr As Array, UpperLeft As String)
        'arr has arr.getlength(0) rows, and arr.getlength(1) columns 
        With xlApp.Range(UpperLeft)
            .ClearContents()
            .Resize(arr.GetLength(0), arr.GetLength(1)).Name = "MyNamedRange"
        End With
    ...
    Public Sub PlotCharts(NumberOrRows As Integer, SuperMarketPump As Boolean, DesignFlow As String, DesignHead As String, ModelNo As String, Impeller As String)
